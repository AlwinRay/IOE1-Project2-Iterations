...
function draw() {
  //The changes I made in this iteration was changing the colour of the circles
  //Also changing the position of the circles
  //familiarizing myself with p5.js again
